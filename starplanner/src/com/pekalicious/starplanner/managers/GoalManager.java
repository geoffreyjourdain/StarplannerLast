...
import com.pekalicious.starplanner.actions.terran.ActionBuildMachineShop;
...
import com.pekalicious.starplanner.actions.terran.ActionBuildControlTower;
import com.pekalicious.starplanner.actions.terran.ActionBuildLaboratory;
...
import com.pekalicious.starplanner.actions.terran.ActionBuildTurret;
import com.pekalicious.starplanner.actions.terran.ActionBuildFactory;
import com.pekalicious.starplanner.actions.terran.ActionBuildPhysicsLab;
...
import com.pekalicious.starplanner.actions.terran.ActionTrainBattlecruiser;
import com.pekalicious.starplanner.actions.terran.ActionTrainValkyrie;
import com.pekalicious.starplanner.actions.terran.ActionTrainVessel;
import com.pekalicious.starplanner.actions.terran.ActionTrainMedic;
import com.pekalicious.starplanner.actions.terran.ActionTrainWraith;
...
import com.pekalicious.starplanner.actions.terran.ActionTrainVulture;
...
public class GoalManager {
	...
	public static StarAction[] getAllBuildOrderActions() {
		return new StarAction[] {
			...
			new ActionTrainMedic(),
			new ActionTrainFirebat(),
			new ActionBuildBarrackAggressive(),
			new ActionBuildBarrack(),
			new ActionTrainMarine(),
			new ActionTrainValkyrie(),
			new ActionBuildEngineeringBay(),
			new ActionBuildCommandCenter(),
			new ActionBuildArmory(),
			new ActionBuildMachineShop(),
			new ActionBuildAcademy(),
			new ActionBuildStarport(),
			new ActionBuildFactory(),
			new ActionTrainTank(),
			new ActionTrainVulture(),
			new ActionBuildControlTower(),
			new ActionTrainWraith(),
			new ActionBuildLaboratory(),
			new ActionBuildPhysicsLab(),
			new ActionTrainBattlecruiser(),
			new ActionTrainVessel(),
			new ActionBuildTurret(),
		};
	}
